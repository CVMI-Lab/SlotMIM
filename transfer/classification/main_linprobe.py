...
def get_args_parser():
    ...
    parser.add_argument('--layer_scale_init_value', default=None, type=float, 
                        help="0.1 for base, 1e-5 for large. set None to disable layer scale")
...
def main(args):
    ...
    if args.finetune and not args.eval:
        ...
        missing_keys = [k for k in msg.missing_keys if not 'relative_position_index' in k]
        if args.global_pool:
    ...
    if args.compile:
        ...
        model_without_ddp = model._orig_mod.module if args.distributed else model._orig_mod
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and misc.is_main_process():
            ...
            if epoch == (args.epochs - 1):
                ...
                shutil.move(output_dir / 'checkpoint-latest.pth', output_dir / ('checkpoint-%s.pth' % str(epoch)))
