...
data_dir="datasets/imglists/openimages_1.28m.txt"
output_dir="output/slotmim_oi1.28m_vitb16_np1024_400ep_ctr8192_cross_pred0.3"

MASTER_PORT=$((RANDOM % 101 + 20001))
torchrun --master_port $MASTER_PORT --nproc_per_node=8 \
