...
class CustomTwoCrop(object):
    def __init__(self, size=224, scale=(0.2, 1.0), ratio=(3. / 4., 4. / 3.), interpolation=Image.BILINEAR,
    ...
    def get_params_conditioned(self, img, scale, ratio, constraint):
        ...
        for counter in range(10):
            ...
            if 0 < w <= width and 0 < h <= height:
                ...
                if intersection >= 0.01 * target_area: # 1 percent of the second crop is part of the first crop.
                    return i, j, h, w
...
class CustomDataAugmentation(object):
    def __init__(self, size=224, min_scale=0.08, return_meta=True):
